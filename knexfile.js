...
let a = {
  ...
  development: {
    ...
    connection: {
      ...
      database: process.env.DB_DEVELOPMENT_DATABASE || 'login_db',
      user: process.env.DB_DEVELOPMENT_USER || 'root',
      password: process.env.DB_DEVELOPMENT_PASSWORD || 'juan',
    },
    pool: {
      min: 2,
      max: 10
  ...
  production: {
    ...
    connection: {
      ...
      database: process.env.DB_PRODUCTION_DATABASE || 'login_db',
      user: process.env.DB_PRODUCTION_USER || 'root',
      password: process.env.DB_PRODUCTION_PASSWORD || 'juan',
    },
    pool: {
      min: 2,
      max: 10
